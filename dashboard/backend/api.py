...
CONFIG_FIELD_MAP: dict[str, str] = {
    ...
    "NGSAT_REGIME_INTRADAY_MULTIPLIER": "regime_intraday_multiplier",
    "NGSAT_REGIME_INTRADAY_CAP": "regime_intraday_cap",
...
class StrategyUpdateRequest(BaseModel):
    ...
    regime_intraday_multiplier: float | None = Field(None, ge=0.5, le=10.0)
    regime_intraday_cap: float | None = Field(None, ge=1.0, le=50.0)
